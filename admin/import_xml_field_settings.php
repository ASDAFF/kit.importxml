...
{
	$OFFER_IBLOCK_ID = \Bitrix\IxmlImportxml\Utils::GetOfferIblock($IBLOCK_ID);
...
if($_POST['action']=='save_margin_template')
{
	...
	$arMarginTemplates = \Bitrix\IxmlImportxml\Extrasettings::SaveMarginTemplate($arPost);
}
elseif($_POST['action']=='delete_margin_template')
{
	$arMarginTemplates = \Bitrix\IxmlImportxml\Extrasettings::DeleteMarginTemplate($_POST['template_id']);
}
...
<form action="" method="post" enctype="multipart/form-data" name="field_settings" class="ixml_ix_settings_form">
	...
	<table width="100%">
		...
		<?if($bPropList){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_PROPLIST_PROPS_SEP");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_PROPLIST_PROPVALS_SEP");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_PROPLIST_CREATE_NEW");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
		...
		<?if($bVideo){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_VIDEO_WIDTH");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_VIDEO_HEIGHT");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
		...
		<?if($bSectionUid){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_SECTION_NAME_SEPARATED");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_SECTION_SEARCH_IN_SUBSECTIONS");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_SECTION_SEARCH_WITHOUT_PARENT");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
		...
		<?if($field=="IE_SECTION_PATH"){?>
			<tr>
				<td class="adm-detail-content-cell-l" valign="top"><?echo GetMessage("IXML_IX_SETTINGS_SECTION_PATH_SEPARATOR");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
					...
					eval('$val = $P'.$fNameEval.';');
					?>
					<input type="text" name="<?=$fName?>" value="<?=htmlspecialcharsbx($val)?>" placeholder="<?echo GetMessage("IXML_IX_SETTINGS_SECTION_PATH_SEPARATOR_PLACEHOLDER");?>">
				</td>
			</tr>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_SECTION_PATH_SEPARATED");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_SECTION_PATH_NAME_SEPARATED");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
					$fName = htmlspecialcharsex($_GET['field_name']).'[SECTION_UID_SEPARATED]';
					$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
		...
		<?if($bCanUseForSKUGenerate){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_USE_FOR_SKU_GENERATE");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
		...
		<?if($isOffer){?>
			<?/*if($bOfferUid){?>
				<tr>
					<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_SEARCH_SINGLE_OFFERS");?>:</td>
					<td class="adm-detail-content-cell-r">
						<?
		...
		<?if($bMultipleProp){?>
			<tr>
				<td class="adm-detail-content-cell-l" valign="top"><?echo GetMessage("IXML_IX_SETTINGS_MULTIPLE_SAVE_OLD_VALUES");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
			...
			<tr>
				<td class="adm-detail-content-cell-l" valign="top"><?echo GetMessage("IXML_IX_SETTINGS_MULTIPLE_FROM_VALUE");?>:<br><small><?echo GetMessage("IXML_IX_SETTINGS_MULTIPLE_FROM_VALUE_COMMENT");?></small></td>
				<td class="adm-detail-content-cell-r">
					<?
					...
					<?echo GetMessage("IXML_IX_SETTINGS_MULTIPLE_TO_VALUE");?>
		...
		<?if($bTextHtml){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_HTML_TITLE");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
					...
					<select name="<?echo $fName;?>">
						<option value=""><?echo GetMessage("IXML_IX_SETTINGS_HTML_NOT_VALUE");?></option>
						<option value="text" <?if($val=='text'){echo 'selected';}?>><?echo GetMessage("IXML_IX_SETTINGS_HTML_TEXT");?></option>
						<option value="html" <?if($val=='html'){echo 'selected';}?>><?echo GetMessage("IXML_IX_SETTINGS_HTML_HTML");?></option>
					</select>
				</td>
			</tr>
		<?}?>
		...
		<?if($bIblockElementSet){?>
			<tr>
				<td class="adm-detail-content-cell-l" valign="top"><?echo GetMessage("IXML_IX_SETTINGS_CHANGE_LINKED_IBLOCK");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
		...
		<?if($field=='IE_CREATED_BY'){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_USER_UID");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
					...
					?>
					<select name="<?echo $fName;?>">
						<option value=""><?echo GetMessage("IXML_IX_SETTINGS_USER_UID_ID");?></option>
						<option value="LOGIN" <?if($val=='LOGIN'){echo 'selected';}?>><?echo GetMessage("IXML_IX_SETTINGS_USER_UID_LOGIN");?></option>
						<option value="EMAIL" <?if($val=='EMAIL'){echo 'selected';}?>><?echo GetMessage("IXML_IX_SETTINGS_USER_UID_EMAIL");?></option>
						<option value="XML_ID" <?if($val=='XML_ID'){echo 'selected';}?>><?echo GetMessage("IXML_IX_SETTINGS_USER_UID_XML_ID");?></option>
					</select>
				</td>
			</tr>
		<?}?>
		...
		<tr>
			<td class="ixml-ix-settings-margin-container" colspan="2">
				...
				?>
				<a href="javascript:void(0)" onclick="return ESettings.AddConversion(this, event)" title="<?echo GetMessage("IXML_IX_SETTINGS_CONVERSION_ADD_HINT");?>"><?echo GetMessage("IXML_IX_SETTINGS_CONVERSION_ADD_VALUE");?></a>
			</td>
		</tr>
		...
		<?if(true /*!$bVariable*/){?>
			...
			<tr>
				<td class="ixml-ix-settings-margin-container" colspan="2">
					...
					?>
					<a href="javascript:void(0)" onclick="return ESettings.AddConversion(this, event)"><?echo GetMessage("IXML_IX_SETTINGS_CONDITION_ADD_VALUE");?></a>
				</td>
			</tr>
		<?}?>
		...
		<?if($bPrice){
			...
			$fNameEval = strtr($fName, array("["=>"['", "]"=>"']"));
			eval('$val = $P'.$fNameEval.';');
			$arMarginTemplates = \Bitrix\IxmlImportxml\Extrasettings::GetMarginTemplates(($pfile=''));
			$showMargin = true;
			...
			<tr class="heading">
				<td colspan="2">
					<div class="ixml-ix-settings-header-links">
						<div class="ixml-ix-settings-header-links-inner">
							<a href="javascript:void(0)" onclick="ESettings.ShowMarginTemplateBlockLoad(this)"><?echo GetMessage("IXML_IX_SETTINGS_LOAD_TEMPLATE"); ?></a> /
							<a href="javascript:void(0)" onclick="ESettings.ShowMarginTemplateBlock(this)"><?echo GetMessage("IXML_IX_SETTINGS_SAVE_TEMPLATE"); ?></a>
						</div>
						<div class="ixml-ix-settings-margin-templates" id="margin_templates">
							<div class="ixml-ix-settings-margin-templates-inner">
								<?echo GetMessage("IXML_IX_SETTINGS_MARGIN_CHOOSE_EXISTS_TEMPLATE"); ?><br>
								<select name="MARGIN_TEMPLATE_ID">
									<option value=""><?echo GetMessage("IXML_IX_SETTINGS_MARGIN_NOT_CHOOSE"); ?></option>
									<?
								...
								<?echo GetMessage("IXML_IX_SETTINGS_MARGIN_NEW_TEMPLATE"); ?><br>
								<input type="text" name="MARGIN_TEMPLATE_NAME" value="" placeholder="<?echo GetMessage("IXML_IX_SETTINGS_MARGIN_TEMPLATE_NAME"); ?>"><br>
								<input type="submit" onclick="return ESettings.SaveMarginTemplate(this, '<?echo GetMessage("IXML_IX_SETTINGS_TEMPLATE_SAVED"); ?>');" name="save" value="<?echo GetMessage("IXML_IX_SETTINGS_SAVE_BTN"); ?>">
							</div>
						</div>
						<div class="ixml-ix-settings-margin-templates" id="margin_templates_load">
							<div class="ixml-ix-settings-margin-templates-inner">
								<?echo GetMessage("IXML_IX_SETTINGS_MARGIN_CHOOSE_TEMPLATE"); ?><br>
								<select name="MARGIN_TEMPLATE_ID">
									<option value=""><?echo GetMessage("IXML_IX_SETTINGS_MARGIN_NOT_CHOOSE"); ?></option>
									<?
									foreach($arMarginTemplates as $key=>$template)
								...
								<a href="javascript:void(0)" onclick="ESettings.RemoveMarginTemplate(this, '<?echo GetMessage("IXML_IX_SETTINGS_TEMPLATE_DELETED"); ?>')" title="<?echo GetMessage("IXML_IX_SETTINGS_DELETE"); ?>" class="delete"></a>
								<input type="submit" onclick="return ESettings.LoadMarginTemplate(this);" name="save" value="<?echo GetMessage("IXML_IX_SETTINGS_LOAD_BTN"); ?>">
							</div>
						</div>
					</div>
					<?echo GetMessage("IXML_IX_SETTINGS_MARGIN_TITLE"); ?>
				</td>
			</tr>
			<tr>
				<td colspan="2" class="ixml-ix-settings-margin-container">
					<div id="settings_margins">
						<?
						foreach($val as $k=>$v)
						{
						?>
							<div class="ixml-ix-settings-margin" style="display: <?=($showMargin ? 'block' : 'none')?>;">
								<?echo GetMessage("IXML_IX_SETTINGS_APPLY"); ?> <select name="<?=$fName?>[TYPE][]"><option value="1" <?=($v['TYPE']==1 ? 'selected' : '')?>><?echo GetMessage("IXML_IX_SETTINGS_APPLY_MARGIN"); ?></option><option value="-1" <?=($v['TYPE']==-1 ? 'selected' : '')?>><?echo GetMessage("IXML_IX_SETTINGS_APPLY_DISCOUNT"); ?></option></select>
								<input type="text" name="<?=$fName?>[PERCENT][]" value="<?=htmlspecialcharsbx($v['PERCENT'])?>">
								<select name="<?=$fName?>[PERCENT_TYPE][]"><option value="P" <?=($v['PERCENT_TYPE']=='P' ? 'selected' : '')?>><?echo GetMessage("IXML_IX_SETTINGS_TYPE_PERCENT"); ?></option><option value="F" <?=($v['PERCENT_TYPE']=='F' ? 'selected' : '')?>><?echo GetMessage("IXML_IX_SETTINGS_TYPE_FIX"); ?></option></select>
								<?echo GetMessage("IXML_IX_SETTINGS_AT_PRICE"); ?> <?echo GetMessage("IXML_IX_SETTINGS_FROM"); ?> <input type="text" name="<?=$fName?>[PRICE_FROM][]" value="<?=htmlspecialcharsbx($v['PRICE_FROM'])?>">
								<?echo GetMessage("IXML_IX_SETTINGS_TO"); ?> <input type="text" name="<?=$fName?>[PRICE_TO][]" value="<?=htmlspecialcharsbx($v['PRICE_TO'])?>">
								<a href="javascript:void(0)" onclick="ESettings.RemoveMargin(this)" title="<?echo GetMessage("IXML_IX_SETTINGS_DELETE"); ?>" class="delete"></a>
							</div>
						<?
						}
						?>
						<input type="button" value="<?echo GetMessage("IXML_IX_SETTINGS_ADD_MARGIN_DISCOUNT"); ?>" onclick="ESettings.AddMargin(this)">
					</div>
				</td>
			</tr>
			...
			<tr class="heading">
				<td colspan="2">
					<?echo GetMessage("IXML_IX_SETTINGS_PRICE_PROCESSING"); ?>
				</td>
			</tr>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_PRICE_ROUND");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
					...
					?>
					<select name="<?=$fName?>">
						<option value=""><?echo GetMessage("IXML_IX_SETTINGS_PRICE_ROUND_NOT");?></option>
						<option value="ROUND" <?if($val=='ROUND') echo 'selected';?>><?echo GetMessage("IXML_IX_SETTINGS_PRICE_ROUND_ROUND");?></option>
						<option value="CEIL" <?if($val=='CEIL') echo 'selected';?>><?echo GetMessage("IXML_IX_SETTINGS_PRICE_ROUND_CEIL");?></option>
						<option value="FLOOR" <?if($val=='FLOOR') echo 'selected';?>><?echo GetMessage("IXML_IX_SETTINGS_PRICE_ROUND_FLOOR");?></option>
					</select>
				</td>
			</tr>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_PRICE_ROUND_COEFFICIENT");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
					...
					<span id="hint_PRICE_ROUND_COEFFICIENT"></span><script>BX.hint_replace(BX('hint_PRICE_ROUND_COEFFICIENT'), '<?echo GetMessage("IXML_IX_SETTINGS_PRICE_ROUND_COEFFICIENT_HINT"); ?>');</script>
				</td>
			</tr>
			
			<?if($field!="ICAT_PURCHASING_PRICE"){?>
				<tr>
					<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_PRICE_USE_EXT");?>:</td>
					<td class="adm-detail-content-cell-r">
						<?
				...
				<tr id="price_ext" <?if($priceExt!='Y'){echo 'style="display: none;"';}?>>
					...
					<td class="adm-detail-content-cell-r">
						...
						eval('$val = $P'.$fNameEval.';');
						?>
						<?echo GetMessage("IXML_IX_SETTINGS_PRICE_QUANTITY_FROM");?>
						...
						eval('$val = $P'.$fNameEval.';');
						?>
						<?echo GetMessage("IXML_IX_SETTINGS_PRICE_QUANTITY_TO");?>
						<input type="text" name="<?=$fName?>" value="<?echo htmlspecialcharsbx($val)?>" size="5">
					</td>
				</tr>
			<?}?>
		...
		<?/*if($bPrice && !empty($arCurrency)){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_FIELD_CURRENCY");?>:</td>
				<td class="adm-detail-content-cell-r">			
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_CONVERT_CURRENCY");?>:</td>
				<td class="adm-detail-content-cell-r">			
					<select name="CONVERT_CURRENCY">
						<option value=""><?echo GetMessage("IXML_IX_CONVERT_NO_CHOOSE");?></option>
					<?
					$lcur = CCurrency::GetList(($by="sort"), ($order1="asc"), LANGUAGE_ID);
					foreach($arCurrency as $item)
					{
			...
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_PRICE_MARGIN");?>:</td>
				<td class="adm-detail-content-cell-r">			
				...
				<td class="adm-detail-content-cell-r">
					...
					foreach($arVals as $k=>$v)
					{
						...
						$select = '<select name="'.$fName2.'" onchange="ESettings.OnValChange(this)">'.
								...
								'<option value="contain" '.($v2=='contain' ? 'selected' : '').'>'.GetMessage("IXML_IX_SETTINGS_FILTER_VAL_CONTAIN").'</option>'.
								'<option value="begin" '.($v2=='begin' ? 'selected' : '').'>'.GetMessage("IXML_IX_SETTINGS_FILTER_VAL_BEGIN").'</option>'.
								'<option value="end" '.($v2=='end' ? 'selected' : '').'>'.GetMessage("IXML_IX_SETTINGS_FILTER_VAL_END").'</option>'.
								'<option value="gt" '.($v2=='gt' ? 'selected' : '').'>'.GetMessage("IXML_IX_SETTINGS_FILTER_VAL_GT").'</option>'.
								'<option value="lt" '.($v2=='lt' ? 'selected' : '').'>'.GetMessage("IXML_IX_SETTINGS_FILTER_VAL_LT").'</option>'.
		...
		<?if($bExtLink){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_LOAD_BY_EXTLINK");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
		...
		<?if($bChangeable){?>
			<tr>
				<td class="adm-detail-content-cell-l"><?echo GetMessage("IXML_IX_SETTINGS_LOADING_MODE");?>:</td>
				<td class="adm-detail-content-cell-r">
					<?
					...
					?>
					<select name="<?=$fName?>">
						<option value=""><?echo GetMessage("IXML_IX_SETTINGS_LOADING_MODE_CHANGE");?></option>
						<option value="ADD_BEFORE"<?if($val=='ADD_BEFORE'){echo 'selected';}?>><?echo GetMessage("IXML_IX_SETTINGS_LOADING_MODE_BEFORE");?></option>
						<option value="ADD_AFTER"<?if($val=='ADD_AFTER'){echo 'selected';}?>><?echo GetMessage("IXML_IX_SETTINGS_LOADING_MODE_AFTER");?></option>
					</select>
				</td>
			</tr>
		<?}?>
		...
		<tr>
			<td class="ixml-ix-settings-margin-container" colspan="2">
				<a href="javascript:void(0)" onclick="ESettings.ShowPHPExpression(this)"><?echo GetMessage("IXML_IX_SETTINGS_FIELD_NOTE");?></a>
				<?
		...
		if(!$bVariable)
		{
			...
			?>
			<tr class="heading">
				<td colspan="2"><?echo GetMessage("IXML_IX_SETTINGS_EXTRA_CONVERSION_TITLE");?></td>
			</tr>
			<tr>
				<td class="ixml-ix-settings-margin-container" colspan="2">
					<?
					...
					foreach($arVals as $k=>$v)
					{
						...
						$cellsOptions .= '<optgroup label="'.GetMessage("IXML_IX_SETTINGS_CONVERSION_CELL_GROUP_OTHER").'">';
						$cellsOptions .= '<option value="LOADED"'.($v['CELL']=='LOADED' ? ' selected' : '').'>'.GetMessage("IXML_IX_SETTINGS_CONVERSION_CELL_LOADED").'</option>';
						$cellsOptions .= '<option value="ELSE"'.($v['CELL']=='ELSE' ? ' selected' : '').'>'.GetMessage("IXML_IX_SETTINGS_CONVERSION_CELL_ELSE").'</option>';
						$cellsOptions .= '</optgroup>';
						...
						echo '<div class="ixml-ix-settings-conversion" '.(!$showCondition ? 'style="display: none;"' : '').'>'.
								...
								' <select name="'.$fName.'[THEN][]">'.
									...
									'</optgroup>'.
									'<optgroup label="'.GetMessage("IXML_IX_SETTINGS_CONVERSION_THEN_GROUP_OTHER").'">'.
										'<option value="NOT_LOAD" '.($v['THEN']=='NOT_LOAD' ? 'selected' : '').'>'.GetMessage("IXML_IX_SETTINGS_CONVERSION_THEN_NOT_LOAD_FIELD").'</option>'.
										'<option value="NOT_LOAD_ELEMENT" '.($v['THEN']=='NOT_LOAD_ELEMENT' ? 'selected' : '').'>'.GetMessage("IXML_IX_SETTINGS_CONVERSION_THEN_NOT_LOAD_ELEMENT").'</option>'.
										'<option value="EXPRESSION" '.($v['THEN']=='EXPRESSION' ? 'selected' : '').'>'.GetMessage("IXML_IX_SETTINGS_CONVERSION_THEN_EXPRESSION").'</option>'.
									'</optgroup>'.
								'</select> '.
								'<input type="text" name="'.$fName.'[TO][]" value="'.htmlspecialcharsbx($v['TO']).'">'.
					...
					?>
					<a href="javascript:void(0)" onclick="return ESettings.AddConversion(this, event)"><?echo GetMessage("IXML_IX_SETTINGS_CONVERSION_ADD_VALUE");?></a>
				</td>
			</tr>
		<?}?>
	</table>
...
var admKDASettingMessages = {
	...
	'HASH_FILEDS': '<?echo htmlspecialcharsex(GetMessage("IXML_IX_SETTINGS_LANG_HASH_FILEDS"));?>',
