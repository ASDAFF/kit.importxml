...
if($_POST['action']=='save')
{
	...
	{
		$error = GetMessage("KIT_IX_MASS_UPLOAD_ERROR_EMPTY_DIR");
	}
}
...
if($success)
{
	CAdminMessage::ShowMessage(array(
		'TYPE' => 'OK',
		'MESSAGE' => GetMessage("KIT_IX_MASS_UPLOAD_SUCCESS")
	));
}
...
<form action="<?=$_SERVER['REQUEST_URI']?>" method="post" enctype="multipart/form-data" name="field_settings">
	...
	<table width="100%">
		...
		<col width="50%">
		<tr>
			<td class="adm-detail-content-cell-l"><?echo GetMessage("KIT_IX_MASS_UPLOAD_FOLDER");?>:</td>
