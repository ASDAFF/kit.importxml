...
class KDAPHPExcel_Chart
{
	 ...
	 * Chart Plot Area
	 *
	 * @var KDAPHPExcel_Chart_PlotArea
	 */
	...
	/**
	 * Create a new KDAPHPExcel_Chart
	 */
	public function __construct($name, KDAPHPExcel_Chart_Title $title = null, KDAPHPExcel_Chart_Legend $legend = null, KDAPHPExcel_Chart_PlotArea $plotArea = null, $plotVisibleOnly = true, $displayBlanksAs = '0', KDAPHPExcel_Chart_Title $xAxisLabel = null, KDAPHPExcel_Chart_Title $yAxisLabel = null)
	{
		$this->_name = $name;
		$this->_title = $title;
		$this->_legend = $legend;
	 ...
	 * @throws	KDAPHPExcel_Chart_Exception
	 * @return KDAPHPExcel_Chart
	 */
	public function setWorksheet(KDAPHPExcel_Worksheet $pValue = null) {
	 ...
	 * Get Title
	 *
	 * @return KDAPHPExcel_Chart_Title
	 */
	 ...
	 * Set Title
	 *
	 * @param	KDAPHPExcel_Chart_Title $title
	 * @return	KDAPHPExcel_Chart
	 */
	public function setTitle(KDAPHPExcel_Chart_Title $title) {
		$this->_title = $title;
	 ...
	 * Get Legend
	 *
	 * @return KDAPHPExcel_Chart_Legend
	 */
	 ...
	 * Set Legend
	 *
	 * @param	KDAPHPExcel_Chart_Legend $legend
	 * @return	KDAPHPExcel_Chart
	 */
	public function setLegend(KDAPHPExcel_Chart_Legend $legend) {
		$this->_legend = $legend;
	 ...
	 * Set X-Axis Label
	 *
	 * @param	KDAPHPExcel_Chart_Title $label
	 * @return	KDAPHPExcel_Chart
	 */
	public function setXAxisLabel(KDAPHPExcel_Chart_Title $label) {
	 ...
	 * @return	KDAPHPExcel_Chart
	 */
	public function setYAxisLabel(KDAPHPExcel_Chart_Title $label) {
	 ...
	 * Get Plot Area
	 *
	 * @return KDAPHPExcel_Chart_PlotArea
	 */
	...
	public function render($outputDestination = null) {
		$libraryName = KDAPHPExcel_Settings::getChartRendererName();
		...
		$libraryPath = KDAPHPExcel_Settings::getChartRendererPath();
		$includePath = str_replace('\\','/',get_include_path());
		$rendererPath = str_replace('\\','/',$libraryPath);
		if (strpos($rendererPath,$includePath) === false) {
			$path = get_include_path() . PATH_SEPARATOR . $libraryPath;
			set_include_path($path);
		}

		$rendererName = 'KDAPHPExcel_Chart_Renderer_'.$libraryName;
