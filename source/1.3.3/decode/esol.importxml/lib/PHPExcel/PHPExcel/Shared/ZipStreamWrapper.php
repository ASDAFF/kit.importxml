...
/**
 * KDAPHPExcel_Shared_ZipStreamWrapper
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Shared
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Shared_ZipStreamWrapper {
	/**
	 * Internal ZipAcrhive
	 *
	 * @var ZipAcrhive
    ...
    public function stream_open($path, $mode, $options, &$opened_path) {
        // Check for mode
        if ($mode[0] != 'r') {
            throw new KDAPHPExcel_Reader_Exception('Mode ' . $mode . ' is not supported. Only read mode is supported.');
        }
