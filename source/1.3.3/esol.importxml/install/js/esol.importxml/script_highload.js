...
var EProfile = {
	...
	ShowCron: function()
	{
		var dialog = new BX.CAdminDialog({
			...
			'content_url':'/bitrix/admin/'+esolIXModuleFilePrefix+'_cron_settings.php?lang='+BX.message('LANGUAGE_ID')+'&suffix=highload',
			'width':'800',
			'height':'400',
			'resizable':true});
	...
	OpenMissignElementFields: function(link)
	{
		...
		var dialogParams = {
			...
			'content_url':'/bitrix/admin/'+esolIXModuleFilePrefix+'_missignelem_fields.php?lang='+BX.message('LANGUAGE_ID')+'&IBLOCK_ID='+iblockId+'&INPUT_ID='+input.attr('id')+'&OLDDEFAULTS='+input.val(),
			'width':'800',
			'height':'400',
			'resizable':true
		};
