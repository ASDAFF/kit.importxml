<?php
global $MESS;
$_2081762281 = str_replace('\\', '/', __FILE__);
$_2081762281 = substr($_2081762281, 0, strlen($_2081762281) - strlen('/index.php'));
IncludeModuleLangFile($_2081762281 . '/install.php');
include($_2081762281 . '/version.php');
...
class esol_importxml extends CModule
{
    ...
    public function __construct()
    {
        ...
        $_1386465784 = str_replace('\\', '/', __FILE__);
        $_1386465784 = substr($_1386465784, 0, strlen($_1386465784) - strlen('/index.php'));

        include($_1386465784 . '/version.php');
