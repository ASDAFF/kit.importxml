...
/**
 * KDAPHPExcel_Shared_CodePage
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_Shared
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
class KDAPHPExcel_Shared_CodePage
{
	/**
	...
	public static function NumberToName($codePage = 1252)
	{
		switch ($codePage) {
			...
			case 720:	throw new KDAPHPExcel_Exception('Code page 720 not supported.');
													break;	//	OEM Arabic
			...
			case 21010: return 'CP1252';			break;	//	ANSI Latin I (BIFF4-BIFF7)
			case 32768:	return 'MAC';				break;	//	Apple Roman
			case 32769:	throw new KDAPHPExcel_Exception('Code page 32769 not supported.');
													break;	//	ANSI Latin I (BIFF2-BIFF3)
			case 65000:	return 'UTF-7';				break;	//	Unicode (UTF-7)
			case 65001:	return 'UTF-8';				break;	//	Unicode (UTF-8)
		}

		throw new KDAPHPExcel_Exception('Unknown codepage: ' . $codePage);
	}
