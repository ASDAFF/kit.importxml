...
if($USER->IsAdmin())
{
	...
	$aTabs = array(
		array("DIV" => "edit0", "TAB" => Loc::getMessage("IXML_IX_SETTINGS"), "ICON" => "", "TITLE" => Loc::getMessage("IXML_IX_SETTINGS_TITLE")),
		array("DIV" => "edit2", "TAB" => Loc::getMessage("MAIN_TAB_RIGHTS"), "ICON" => "form_settings", "TITLE" => Loc::getMessage("MAIN_TAB_TITLE_RIGHTS")),
	);
	$tabControl = new CAdminTabControl("ixmlImportxmlTabControl", $aTabs, true, true);
	...
	?>
	<tr>
		<td width="50%"><? echo Loc::getMessage('IXML_IX_SET_MAX_EXECUTION_TIME'); ?></td>
		<td width="50%">
	...
	<tr id="MAX_EXECUTION_TIME" <?if(!$setMaxExecutionTime){echo 'style="display: none;"';}?>>
		<td width="50%"><? echo Loc::getMessage('IXML_IX_MAX_EXECUTION_TIME'); ?></td>
		<td width="50%">
	...
	<tr id="EXECUTION_DELAY" <?if(!$setMaxExecutionTime){echo 'style="display: none;"';}?>>
		<td width="50%"><? echo Loc::getMessage('IXML_IX_EXECUTION_DELAY'); ?></td>
		<td width="50%">
	...
	<tr>
		<td width="50%"><? echo Loc::getMessage('IXML_IX_AUTO_CONTINUE_IMPORT'); ?></td>
		<td width="50%">
	...
	<tr>
		<td width="50%"><? echo Loc::getMessage('IXML_IX_AUTO_CORRECT_ENCODING'); ?></td>
		<td width="50%">
	...
	<tr class="heading">
		<td colspan="2"><? echo Loc::getMessage('IXML_IX_OPTIONS_CRON_SETTINGS'); ?></td>
	</tr>
	<tr>
		<td><? echo Loc::getMessage('IXML_IX_OPTIONS_CRON_NEED_CHECKSIZE'); ?> <span id="hint_CRON_NEED_CHECKSIZE"></span><script>BX.hint_replace(BX('hint_CRON_NEED_CHECKSIZE'), '<?echo Loc::getMessage("IXML_IX_OPTIONS_CRON_NEED_CHECKSIZE_HINT"); ?>');</script></td>
		<td>
	...
	<tr>
		<td><? echo Loc::getMessage('IXML_IX_OPTIONS_CRON_CONTINUE_LOADING'); ?></td>
		<td>
	...
	<tr>
		<td><? echo Loc::getMessage('IXML_IX_OPTIONS_CRON_REMOVE_LOADED_FILE'); ?></td>
		<td>
	...
	<tr class="heading">
		<td colspan="2"><? echo Loc::getMessage('IXML_IX_OPTIONS_NOTIFY'); ?></td>
	</tr>
	<tr>
		<td><? echo Loc::getMessage('IXML_IX_OPTIONS_NOTIFY_MODE'); ?>:</td>
		<td>
			<label><input type="radio" name="SETTINGS[NOTIFY_MODE]" value="NONE" <?if(COption::GetOptionString($module_id, 'NOTIFY_MODE', 'NONE')=='NONE') echo 'checked';?>> <? echo Loc::getMessage('IXML_IX_OPTIONS_NOTIFY_MODE_NONE'); ?><label><br>
			<label><input type="radio" name="SETTINGS[NOTIFY_MODE]" value="CRON" <?if(COption::GetOptionString($module_id, 'NOTIFY_MODE', 'NONE')=='CRON') echo 'checked';?>> <? echo Loc::getMessage('IXML_IX_OPTIONS_NOTIFY_MODE_CRON'); ?><label><br>
			<label><input type="radio" name="SETTINGS[NOTIFY_MODE]" value="ALL" <?if(COption::GetOptionString($module_id, 'NOTIFY_MODE', 'NONE')=='ALL') echo 'checked';?>> <? echo Loc::getMessage('IXML_IX_OPTIONS_NOTIFY_MODE_ALL'); ?><label>
		</td>
	</tr>
	<tr>
		<td><? echo Loc::getMessage('IXML_IX_OPTIONS_NOTIFY_EMAIL'); ?>:</td>
		<td>
			<input type="text" name="SETTINGS[NOTIFY_EMAIL]" value="<?echo htmlspecialcharsex(COption::GetOptionString($module_id, 'NOTIFY_EMAIL'));?>">
		</td>
	</tr>
	<tr>
		<td><? echo Loc::getMessage('IXML_IX_OPTIONS_NOTIFY_BEGIN_IMPORT'); ?>:</td>
		<td>
	...
	<tr>
		<td><? echo Loc::getMessage('IXML_IX_OPTIONS_NOTIFY_END_IMPORT'); ?>:</td>
		<td>
	...
	<tr class="heading">
		<td colspan="2"><? echo Loc::getMessage('IXML_IX_OPTIONS_DISCOUNT'); ?></td>
	</tr>
	<tr>
		<td><? echo Loc::getMessage('IXML_IX_OPTIONS_DISCOUNT_MODE'); ?>:</td>
		<td>
			<label><input type="radio" name="SETTINGS[DISCOUNT_MODE]" value="SPLIT" <?if(COption::GetOptionString($module_id, 'DISCOUNT_MODE', 'SPLIT')=='SPLIT') echo 'checked';?>> <? echo Loc::getMessage('IXML_IX_OPTIONS_DISCOUNT_MODE_SPLIT'); ?></label><br>
			<label><input type="radio" name="SETTINGS[DISCOUNT_MODE]" value="JOIN" <?if(COption::GetOptionString($module_id, 'DISCOUNT_MODE', 'SPLIT')=='JOIN') echo 'checked';?>> <? echo Loc::getMessage('IXML_IX_OPTIONS_DISCOUNT_MODE_JOIN'); ?></label><br>
		</td>
	</tr>
	
	<tr class="heading">
		<td colspan="2"><? echo Loc::getMessage('IXML_IX_OPTIONS_EXTERNAL_SERVICES'); ?></td>
	</tr>
	<tr>
		<td colspan="2" align="center"><b><? echo Loc::getMessage('IXML_IX_OPTIONS_YANDEX_DISC'); ?></b></td>
	</tr>
	<tr>
		<td><? echo Loc::getMessage('IXML_IX_OPTIONS_YANDEX_DISC_APIKEY'); ?>:</td>
		<td>
			...
			&nbsp; <a href="https://oauth.yandex.ru/authorize?response_type=token&client_id=30e9fb3edb184522afaf5e72ee255cbc" target="_blank"><? echo Loc::getMessage('IXML_IX_OPTIONS_YANDEX_DISC_APIKEY_GET'); ?></a>
		</td>
	</tr>
	<tr>
		<td colspan="2" align="center"><br><b><? echo Loc::getMessage('IXML_IX_OPTIONS_CLOUD_MAILRU'); ?></b></td>
	</tr>
	<tr>
		<td><? echo Loc::getMessage('IXML_IX_OPTIONS_CLOUD_MAILRU_LOGIN'); ?>:</td>
		<td>
	...
	<tr>
		<td><? echo Loc::getMessage('IXML_IX_OPTIONS_CLOUD_MAILRU_PASSWORD'); ?>:</td>
		<td>
...
{
	if (confirm('<? echo CUtil::JSEscape(Loc::getMessage("IXML_IX_OPTIONS_BTN_HINT_RESTORE_DEFAULT_WARNING")); ?>'))
	...
	<input type="submit" name="Update" value="<?echo Loc::getMessage("IXML_IX_OPTIONS_BTN_SAVE")?>">
	<input type="hidden" name="Update" value="Y">
	<input type="reset" name="reset" value="<?echo Loc::getMessage("IXML_IX_OPTIONS_BTN_RESET")?>">
	<input type="button" title="<?echo Loc::getMessage("IXML_IX_OPTIONS_BTN_HINT_RESTORE_DEFAULT")?>" onclick="RestoreDefaults();" value="<?echo Loc::getMessage("IXML_IX_OPTIONS_BTN_RESTORE_DEFAULT")?>">
	<?$tabControl->End();?>
	</form>
<?
}
