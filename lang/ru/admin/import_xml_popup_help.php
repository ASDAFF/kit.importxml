<?
$MESS["KIT_IX_HELP_TAB1"] = "Видео-инструкции";
$MESS["KIT_IX_HELP_TAB1_ALT"] = "Видео-инструкции по настройке импорта";
$MESS["KIT_IX_HELP_TAB2"] = "FAQ";
$MESS["KIT_IX_HELP_TAB2_ALT"] = "Вопросы и ответы по работе модуля";
$MESS["KIT_IX_HELP_VIDEO_COMMON"] = "Основная инструкция по импорту";
$MESS["KIT_IX_HELP_VIDEO_YML_PARAMS"] = "Загрузка параметров из YML-файла";
$MESS["KIT_IX_HELP_VIDEO_OFFERS"] = "Импорт торговых предложений";
$MESS["KIT_IX_FAQ_PROLOG"] = "Внимание! Если Вы не нашли ответ на свой вопрос, то задайте его нам по почте. <br>Адрес техподержки: <a href=\"mailto:%s\">%s</a>.";
$MESS["KIT_IX_FAQ_QUEST_SLOW_IMPORT"] = "Почему импорт проходит очень медленно?";
$MESS["KIT_IX_FAQ_ANS_SLOW_IMPORT"] = "Есть несколько причин медленного импорта:
	<ul>
...
$MESS["KIT_IX_FAQ_QUEST_BOOL"] = "Как загрузить булево значение?";
$MESS["KIT_IX_FAQ_ANS_BOOL"] = "Для передачи булевых полей используйте следующие значения:
	<ul>
