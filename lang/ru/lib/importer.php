...
$MESS['KIT_IX_ADD_ELEMENT_ERROR'] = "Ошибка при создании элемента: %s (%s)";
$MESS['KIT_IX_UPDATE_ELEMENT_ERROR'] = "Ошибка при изменении элемента: %s (%s)";
$MESS['KIT_IX_ADD_OFFER_ERROR'] = "Ошибка при создании торгового предложения: %s (%s)";
$MESS['KIT_IX_UPDATE_OFFER_ERROR'] = "Ошибка при обновлении торгового предложения: %s (%s)";
$MESS['KIT_IX_FIELD_VAL_N'] = "0,нет,Нет,НЕТ,not,n,false";
...
$MESS['KIT_IX_DISCOUNT_NAME_TYPE_S'] = "Скидка с фиксированной ценой";
$MESS['KIT_IX_FATAL_ERROR'] = "Ошибка выполнения скрипта: [%s] %s.<br>Файл: %s, строка %s<br>";
$MESS['KIT_IX_PRODUCTS_TAG_1C'] = "Товары";
