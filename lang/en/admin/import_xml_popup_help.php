...
$MESS["KIT_IX_HELP_TAB1"] = "Video instructions";
$MESS["KIT_IX_HELP_TAB1_ALT"] = "Tuning import video instructions";
$MESS["KIT_IX_HELP_TAB2"] = "FAQ";
$MESS["KIT_IX_HELP_TAB2_ALT"] = "Questions and answers on the operation of the module";
$MESS["KIT_IX_HELP_VIDEO_COMMON"] = "Basic instruction on imports";
$MESS["KIT_IX_HELP_VIDEO_YML_PARAMS"] = "Import parameters from a YML-file";
$MESS["KIT_IX_HELP_VIDEO_OFFERS"] = "Import of trade offers";
$MESS["KIT_IX_FAQ_QUEST_SLOW_IMPORT"] = "Why import is very slow?";
$MESS["KIT_IX_FAQ_ANS_SLOW_IMPORT"] = "There are several reasons for the slow imports:
	<ul>
...
$MESS["KIT_IX_FAQ_QUEST_BOOL"] = "How to download a boolean value?";
$MESS["KIT_IX_FAQ_ANS_BOOL"] = "To transmit boolean fields using the following meanings:
	<ul>
		<li>\"1\", \"yes\", \"y\" - true</li>
		<li>\"0\", \"not\", \"n\" - false</li>
	</ul>
